...
import example.operator.keyvalue.EvenOddKeyByFunction;
 ...
 * DataSource
 */
public class FlinkMulitRecordTest {
...
//		dataSource.print();
		...
		KeyedStream keyedStream = dataSource.keyBy(new EvenOddKeyByFunction());
//		keyedStream.print();

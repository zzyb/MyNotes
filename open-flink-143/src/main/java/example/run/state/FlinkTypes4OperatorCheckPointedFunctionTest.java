...
import example.operator.state.OperatorCheckPointedFunctionByRichFlatMap;
 ...
 * DataSource
 */
public class FlinkTypes4OperatorCheckPointedFunctionTest {
...
//        KeyedStream keyedStream = s1.keyBy(new Tuple4WithTimeKeyBy());
        ...
        SingleOutputStreamOperator checkPointedFunctionFlatMap = s1.flatMap(new OperatorCheckPointedFunctionByRichFlatMap());

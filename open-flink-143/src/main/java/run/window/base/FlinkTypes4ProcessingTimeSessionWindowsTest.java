 ...
 * DataSource
 */
public class FlinkTypes4ProcessingTimeSessionWindowsTest {
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream window = keyedStream.window(ProcessingTimeSessionWindows.withGap(Time.milliseconds(3000L)));

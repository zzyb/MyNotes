 ...
 * DataSource
 */
public class FlinkTypes4WindowProcessFunctionWithOutSideTest {
    public static void main(String[] args) throws Exception {
        ...
        // 侧输出--用于告警
        OutputTag<Tuple2<String, Integer>> outputTag = new OutputTag<Tuple2<String, Integer>>("warn") {};
        ...
        SingleOutputStreamOperator process = window.process(new ProcessWindowFunction<Tuple4<String, String, String, Integer>, Tuple4<String, ArrayList<String>, String, Integer>, String, TimeWindow>() {
            ...
            public void process(String key, Context context, Iterable<Tuple4<String, String, String, Integer>> elements, Collector<Tuple4<String, ArrayList<String>, String, Integer>> out) throws Exception {
                ...
                // 如果积分小于等于-2，发往侧输出告警
                if (sum.get() <= -2) {
                    Tuple2<String, Integer> warnValue = new Tuple2<>();
                    warnValue.setFields(t4.f0, sum.get());
                    context.output(outputTag, warnValue);
                }
            }
        });
        ...
        // 侧输出
        DataStream sideOutput = process.getSideOutput(outputTag);
        sideOutput.print();

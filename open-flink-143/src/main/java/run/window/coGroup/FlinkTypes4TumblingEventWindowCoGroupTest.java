 ...
 */
public class FlinkTypes4TumblingEventWindowCoGroupTest {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource sourceA = env.fromCollection(
                new ArrayList<Tuple4<String, String, String, Integer>>(
                        Arrays.asList(
                                new Tuple4<String, String, String, Integer>("郑州", "购买", "2022-03-11 11:30:00", 1),
                                new Tuple4<String, String, String, Integer>("郑州", "购买", "2022-03-11 11:30:00", 1),
                                new Tuple4<String, String, String, Integer>("上海", "购买1", "2022-03-11 11:30:00", 1),
                                new Tuple4<String, String, String, Integer>("上海", "购买2", "2022-03-11 11:30:00", 1)
                        )
                )
        );
        ...
        DataStreamSource sourceC = env.fromCollection(
                new ArrayList<Tuple4<String, String, String, Integer>>(
                        Arrays.asList(
                                new Tuple4<String, String, String, Integer>("上海", "出售1", "2022-03-11 11:30:00", 1),
                                new Tuple4<String, String, String, Integer>("上海", "出售2", "2022-03-11 11:30:00", 1),
                                new Tuple4<String, String, String, Integer>("上海", "出售3", "2022-03-11 11:30:00", 1),
                                new Tuple4<String, String, String, Integer>("上海", "出售4", "2022-03-11 11:30:00", 1)
                        )
                )
        );
...
//                    }
//                });
                .apply(new CoGroupFunction<Tuple4<String, String, String, Integer>, Tuple4<String, String, String, Integer>, String>() {
                    @Override
                    public void coGroup(Iterable<Tuple4<String, String, String, Integer>> first, Iterable<Tuple4<String, String, String, Integer>> second, Collector<String> out) throws Exception {
